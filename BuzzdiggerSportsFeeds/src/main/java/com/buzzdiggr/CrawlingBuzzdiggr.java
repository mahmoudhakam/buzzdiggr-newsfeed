...
public class CrawlingBuzzdiggr
{

	private static final Logger log = LoggerFactory.getLogger(CrawlingBuzzdiggr.class);
	...
	{
		SpringApplication.run(CrawlingBuzzdiggr.class, args);
	}
