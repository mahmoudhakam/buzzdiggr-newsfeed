...
import com.buzzdiggr.models.Tweet;
...
//		config.put(ConsumerConfig.FETCH_MAX_BYTES_CONFIG, "3000000");
	...
	public ConsumerFactory<String, Tweet> tweetConsumerFactory()
	{
		...
		return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(Tweet.class, false));
	}
	...
	public ConsumerFactory<String, Article> articleConsumerFactory()
	{
		...
		config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
		config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
		return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(Article.class, false));
	}
